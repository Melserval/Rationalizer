...
/**
 * Визуализация объекта - списка элементов ассортимента.
 * спользуя новый подход:
 * теперь вью сам извлекает данные и отображает их,
 * а объект с данными ничего о вью не знает и не связан с ним.
 */
class ViewArticleList {
